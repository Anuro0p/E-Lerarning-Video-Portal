...
if(isset($_POST['submit']))
{
	...
	$loginobj= new User();
	$retval=$loginobj->facultychangepassword($email,$oldpassword,$password);
									...
									<div class="card-body">
										<form method="POST" action="" name="f1" onsubmit="return validateform()">
											<div class="form-group">
												...
												<input type="password" class="form-control" id="exampleInputEmail1" name="oldpassword" aria-describedby="emailHelp" placeholder="Enter existing password" required>
