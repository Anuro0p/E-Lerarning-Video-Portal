...
if(isset($_POST['submit']))
{
	...
	$batchobj= new Batch();
	$retval=$batchobj->addBatch($batch,$departmantId,$programId,$startDate,$endDate);
									...
									<div class="card-body">
										<form method="POST" action="">
											<div class="form-group">
												...
												<input type="text" class="form-control" id="exampleInputEmail1" name="batch" aria-describedby="emailHelp" placeholder="Enter Batch Name">


												

												<!-- department select -->
												<label for="defaultSelect">Start Date - End date</label>
												<select name="department" id="dept" class="form-control form-control" placeholder="Select Department" selected id="defaultSelect">
													<option hidden class="text-muted" ><p class="text-muted">Select Department</p></option>
												<?php
												...
												<!-- Date select -->
												<label for="defaultSelect ">Enter period</label>
